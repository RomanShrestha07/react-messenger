...
import {Avatar, Button, Card, Col, Input, Row, Tooltip, Typography} from "antd";
import {
    ExclamationCircleTwoTone, GifOutlined, LikeTwoTone, PhoneTwoTone, PictureTwoTone, PlusCircleTwoTone, SmileTwoTone,
    UserOutlined, VideoCameraTwoTone
    ...
    const CardTitle = () => {
        return (
            <Row>
                ...
                <Title level={4} style={{marginLeft: 8, marginTop: 5}}>Jane Doe</Title>
            </Row>
        )
    };
                ...
                <Col span={8}>
                    <Tooltip placement="bottom" title={'Start a voice call'}>
                        <Button
                            ...
                            shape="circle"
                            size='large'
                            icon={<PhoneTwoTone style={extra_icon_style}/>}
                        />
                    </Tooltip>
                </Col>
                ...
                <Col span={8}>
                    <Tooltip placement="bottom" title={'Start a video call'}>
                        <Button
                            ...
                            shape="circle"
                            size='large'
                            icon={<VideoCameraTwoTone style={extra_icon_style}/>}
                        />
                    </Tooltip>
                </Col>
                ...
                <Col span={8}>
                    <Tooltip placement="bottom" title={'Conversation information'}>
                        <Button
                            ...
                            style={rightSidebarState ? {backgroundColor: '#cae9ff'} : {}}
                        />
                    </Tooltip>
                </Col>
            </Row>
                        ...
                        <Row>
                            <Col span={24}>
                                <Input
                                    ...
                                    suffix={<Button type='text' shape='circle'><SmileTwoTone/></Button>}
                                />
                            </Col>
                        </Row>
                    </Col>
